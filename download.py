...
from PlaystoreDownloader.PlaystoreClient import ConfigFileProvider
...
def main():
    args = get_cmd_args() 
    try:
        playstore_client = PlaystoreClient.PlaystoreClient(ConfigFileProvider(args.credentials))
